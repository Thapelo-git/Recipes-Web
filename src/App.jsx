...
function App() {
 const  [menuOpen,setMenuOpen]=useState(false)
  ...
  return (
    <Router >
     <div className="relative md:w-[20%] bg-white w-screen fixed h-full">
    <Navbar  menuOpen={menuOpen} setMenuOpen={setMenuOpen}/>
    </div>
      <Header setMenuOpen={setMenuOpen}/>
      <div className='md:w-[80%] w-full md:h-[70%] h-screen  flex md:ml-[20%] p-4  overflow-x-auto scrollbar-hide'>
      <Routes >
