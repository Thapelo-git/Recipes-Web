...
function RecipeCard({ recipe}) {
  ...
  return (
    <div
      className={`md:overflow-x-auto md:snap-x md:snap-mandatory 
    flex flex-col md:flex-row
     md:scrollbar-hide gap-4 p-4  w-full  `}
    >
          ...
          >
            <div className="h-full w-full ">
              <img
                src={recipe.image}
                className="h-full w-full   rounded-xl  top-0  shadow"
              />
            </div>
            ...
            <div className="flex flex-row justify-between items-center w-full ">
              <div className="flex flex-row justify-center text-sm items-center gap-1">
                <IoTimeOutline className={`${textColor}`} />{" "}
                <p className={`${textColor}`}>{recipe.timeMinutes} minutes</p>
              </div>
              ...
              <p
                className={`text-sm italic ${recipe.difficulty === "easy" ? "text-green-400" : "text-orange-400"}`}
              >{`${recipe.difficulty === "easy" ? "easy" : "medium"}`}</p>
            </div>
            ...
            <div className="flex flex-row justify-between items-center w-full b-0">
              <button
                ...
                className="text-white text-sm h-8 p-2 w-25 flex justify-center items-center bg-green-500 rounded-lg"
              >
                View Recipes
              </button>
              <button
