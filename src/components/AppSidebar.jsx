...
export function AppSidebar() {
  ...
  return (
    <Sidebar
      collapsible="icon"
      className="border-r border-border/40 shadow-2xl shadow-black/5 bg-gradient-to-br from-orange-100 via-white to-orange-50 md:bg-white md:backdrop-blur-xl transition-all duration-300"
    >
      <SidebarHeader className="flex flex-col items-center pt-8 pb-6 px-4">
        {!collapsed ? (
          <div className="flex flex-col items-center w-full animate-in fade-in zoom-in-95 duration-500">
            <h2 className="text-3xl font-display font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-amber-600 mb-6 drop-shadow-sm tracking-tight text-center">
              Chefie
            </h2>
            <div className="relative group cursor-pointer mb-4">
              <div className="absolute -inset-1 bg-gradient-to-r from-orange-400 to-amber-600 rounded-full blur-[14px] opacity-30 group-hover:opacity-60 transition duration-500" />
              <div className="relative w-24 h-24 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center text-4xl shadow-xl border-4 border-white transform group-hover:scale-[1.03] transition-all duration-300">
                👩‍🍳
              </div>
            </div>
